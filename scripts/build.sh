...
make_xcframework() {
  ...
  # Build a macOS versioned framework bundle (deep bundle)
  # macOS requires Versions/Current/Resources/Info.plist — shallow bundles are rejected.
...
IPEOF
  ...
  # macOS framework symlinks (required for deep bundle structure)
